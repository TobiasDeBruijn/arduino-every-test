...
AVRDUDE=$(find target/arduino/packages/arduino/tools/avrdude -type f -name avrdude | head -n 1)
AVRCONF=$(find target/arduino/packages/arduino/tools/avrdude -type f -name avrdude.conf | head -n 1)
